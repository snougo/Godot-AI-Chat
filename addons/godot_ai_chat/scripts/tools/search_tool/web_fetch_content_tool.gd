...
func _init() -> void:
	...
	tool_description = "Fetches a web page and extracts its main text content. " + \
		"Use this when you need to read the actual content of a URL, " + \
		"rather than just getting search results. " + \
